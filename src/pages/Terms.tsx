    ...
    content: (
      <>
        <p>
          ...
          e-commerce business specialising in bottled water, water coolers, dispensers and
          accessories.
        </p>
        <p>
    ...
    content: (
      <>
        ...
        <p>
          ...
          the instructions provided. Water coolers and dispensers include manufacturer warranties as
